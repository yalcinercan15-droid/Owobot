...
# --- SÜRELER (COOLDOWNS) ---
HUNT_COOLDOWN = 15            # 15 Saniye (Test için hızlı)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        ...
        "• <code>/cf &lt;miktar&gt; &lt;yazi/tura&gt;</code> ➔ 🪙 Yazi-Tura (Animasyonlu)\n"
        "• <code>/slots &lt;miktar&gt;</code> ➔ 🎰 Slot Makinesi (Animasyonlu)\n"
        "• <code>/bj &lt;miktar&gt;</code> ➔ 🃏 Blackjack (Animasyonlu)\n"
...
async def pray(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    data["last_pray"] = now
    data["luck_boost"] = 1.3
    data["luck_until"] = now + 300 # 5 dakika x1.3 sans
...
async def hunt(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Sansli avda kurabiye dusme ihtimali
...
async def daily(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Istegin uzere: Hem para hem de rastgele kutu veriliyor
    reward_coins = 2000
